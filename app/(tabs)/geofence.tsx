  ...
  async function useCurrentLocation() {
    ...
    try {
      ...
      const pos = await Location.getCurrentPositionAsync({
        ...
        timeInterval: 0 // don't coalesce with other requests
      });
      console.log("Got current position: ", pos); // Debug log
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        {loading ? (
          ...
          <>
            {/* Map preview */}
            {Platform.OS !== "web" && MapView && mapLat !== 0 ? (
              <View style={styles.mapBox}>
                <MapView
                  ...
                  initialRegion={{
                    latitude: mapLat,
                    longitude: mapLng,
                    latitudeDelta: (mapRadius / 111000) * 5,
                    longitudeDelta: (mapRadius / 111000) * 5
                  }}
                  scrollEnabled
                  zoomEnabled
                  pitchEnabled={false}
                ...
                <View style={styles.mapLabel}>
                  ...
                  <Text style={styles.mapLabelText}>Radius: {Math.round(mapRadius)} m</Text>
                </View>
                <TouchableOpacity
              ...
              <View style={styles.mapFallback}>
                ...
                <Text style={styles.mapFallbackText}>
                  Center: {lat}, {lng} · Radius: {radius} m
                </Text>
              </View>
            )}
            ...
            <View style={styles.section}>
              <ConfigField
                ...
                keyboardType="decimal-pad"
                hint="Above this speed the vehicle is 'moving'"
              />
              <ConfigField
